...
local settingsTable = {
	General = {
		...
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'Njen Keybind'},
		-- buildwarnings
		-- rayfieldprompts
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Njen') or game:GetObjects("rbxassetid://10804731440")[1]
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "Njen Interface",
					Content = "Enjoying this UI library? Donate in Telehram @siZhens",
					Duration = 3,
					Image = 4370033185,
				})
			end
